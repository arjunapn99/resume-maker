...
const testimonials = [
    {
        ...
        content:
            'A resume maker website is a web-based tool that allows users to create and customize a professional resume to their desired specifications. These websites typically provide templates for creating a resume.',
        avatar:
            'https://avatars.githubusercontent.com/u/160587595?v=4',
    }
];
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Learn more about the Resume Maker website and its mission to provide easy-to-use tools for creating professional resumes." />
                <meta name="keywords" content="resume maker, about us, mission, professional resumes, tools" />
                <meta name="author" content="Arjun Sahu" />
                <meta name="robots" content="index, follow" />
                <meta property="og:title" content="About Us - Resume Maker" />
                <meta property="og:description" content="Learn more about the Resume Maker website and its mission to provide easy-to-use tools for creating professional resumes." />
            ...
            <Flex
                ...
                <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
                    ...
                    <chakra.h2
                        ...
                        Make the Resume That Gets You Hired!
                    </chakra.h2>
                </Box>
                <SimpleGrid
                    columns={{ base: 1, xl: 1 }}
